//
//  UIButton+BInspectable.m
//  OCIBInspectableDm
//
//  Created by zz on 2021/8/18.
//

#import "UIButton+BInspectable.h"
...
@implementation UIButton (BInspectable)
...
- (void)setFixUltraLightFont:(CGFloat)fixUltraLightFont {
    ...
    self.titleLabel.font = [UIFont systemFontOfSize:kAdaptW(fixUltraLightFont) weight:UIFontWeightUltraLight];
}
...
- (void)setFixThinFont:(CGFloat)fixThinFont {
    ...
    self.titleLabel.font = [UIFont systemFontOfSize:kAdaptW(fixThinFont) weight:UIFontWeightThin];
}
...
- (void)setFixLightFont:(CGFloat)fixLightFont {
    ...
    self.titleLabel.font = [UIFont systemFontOfSize:kAdaptW(fixLightFont) weight:UIFontWeightLight];
}
...
- (void)setFixRegularFont:(CGFloat)fixRegularFont {
    ...
    self.titleLabel.font = [UIFont systemFontOfSize:kAdaptW(fixRegularFont) weight:UIFontWeightRegular];
}
...
- (void)setFixMediumFont:(CGFloat)fixMediumFont {
    ...
    self.titleLabel.font = [UIFont systemFontOfSize:kAdaptW(fixMediumFont) weight:UIFontWeightMedium];
}
...
- (void)setFixSemiboldFont:(CGFloat)fixSemiboldFont {
    ...
    self.titleLabel.font = [UIFont systemFontOfSize:kAdaptW(fixSemiboldFont) weight:UIFontWeightSemibold];
}
...
- (void)setFixBoldFont:(CGFloat)fixBoldFont {
    ...
    self.titleLabel.font = [UIFont systemFontOfSize:kAdaptW(fixBoldFont) weight:UIFontWeightBold];
}
...
- (void)setFixHeavyFont:(CGFloat)fixHeavyFont {
    ...
    self.titleLabel.font = [UIFont systemFontOfSize:kAdaptW(fixHeavyFont) weight:UIFontWeightHeavy];
}
...
- (void)setFixBlackFont:(CGFloat)fixBlackFont {
    ...
    self.titleLabel.font = [UIFont systemFontOfSize:kAdaptW(fixBlackFont) weight:UIFontWeightBlack];
}
